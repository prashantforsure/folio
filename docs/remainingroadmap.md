...
**✓ BUILT 2026-09-24 — the story-to-script pipeline** (roadmap task 4.5): a story to a draft in
six stages on the worker, with checkpoints, chained scene batches and a critic pass; every stage's
output stored in `agent_run_stages` (`0038`).
