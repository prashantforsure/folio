...
import type { IdentityLog } from '../script/identity'

/**
 * **Outline only.** The Slate editor's identity wrapper, kept for the Outline
 * route until it is ported to Tiptap (the Script route's is
 * `_script/editor/extensions/identity.ts`). Retire with `_outline/editor/`.
 *
