...
/**
 * The Revisions route. One implementation for both `?view=` values; the
 * header and body share one `cache()`d read.
 */
const Page = (props: PageProps<'/app/project/[projectId]/[episodeId]/revisions'>) => (
  <EpisodeRoutePage
    route="revisions"
    {...props}
