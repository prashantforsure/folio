 ...
 * Meera"), the deliberate one is the README's own copy. Both disabled
 * while a decision is in flight, so a double click is one decision.
 */
export const ConflictBlock = ({
  ...
  /** The accept button's label - what happens: `It's Meera`. */
