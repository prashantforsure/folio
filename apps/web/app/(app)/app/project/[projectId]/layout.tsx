 ...
 * that are the same on every route - the rail, through `ProjectShell`; the
 * assistant panel is app-wide since roadmap task 2.2 (`app/(app)/layout.tsx`)
 * and reads this project from the shell - and the writing layout one
